...
exports.editBook =  async (req,res)=>
    {
       ...
       await books.update({bookName : bookName, bookPrice : bookPrice, bookAuthor : bookAuthor, bookGenre : bookGenre},{where : { id : id}}) //Select * from book
        res.json({
            messagae : id + "updated successfully"
        })
    }
